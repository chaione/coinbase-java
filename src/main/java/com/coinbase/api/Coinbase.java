...
public interface Coinbase {
     ...
     *
     */
    public com.coinbase.api.entity.UserResponse createUser(User userParams) throws CoinbaseException, IOException;
     ...
     *
     */
    public com.coinbase.api.entity.UserResponse createUser(User userParams, String clientId, String scope) throws CoinbaseException, IOException;
